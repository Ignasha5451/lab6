...
MODULE_AUTHOR("Molochko Ignatiy");
MODULE_DESCRIPTION("Laboratory work 6");
MODULE_LICENSE("Dual BSD/GPL");

static unsigned int parametr = 1;

module_param(parametr, uint, S_IRUGO);

MODULE_PARM_DESC(parametr, "The number of times the string 'Hello world!' will be printed");
...
{
    if (parametr == 0 || (parametr >= 5 && parametr <= 10)) {
